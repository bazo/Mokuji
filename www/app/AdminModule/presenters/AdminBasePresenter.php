<?php
abstract class Admin_BasePresenter extends Presenter
{
    ...
    public function startup()
    {
            ...
            if($langs == NULL)
            {
                $this->langs = $this->translator->getSupportedLangs();//$this->model('lang')->getAll();
    ...
    protected function createComponentLangSelector($name)
    {
