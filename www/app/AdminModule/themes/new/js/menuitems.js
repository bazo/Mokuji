...
jQuery.extend({
    ...
    $('#menuItemsEditor').livequery(function(){
        
    if($('#frmformNewMenuItem-link_type-0').attr('checked') == 'checked') 
    {
        $('#frmformNewMenuItem-internal_url').closest('tr').hide();
        $('#frmformNewMenuItem-external_url').closest('tr').show();    
    }
    if($('#frmformNewMenuItem-link_type-1').attr('checked') == 'checked') 
    {
        $('#frmformNewMenuItem-internal_url').closest('tr').show();
        $('#frmformNewMenuItem-external_url').closest('tr').hide();    
    }
    });
