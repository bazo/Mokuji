...
abstract class WebLoader extends Control
{
	...
	/** @var string */
	public $generatedFileNamePrefix = "";
	...
	public function getGeneratedFilename(array $files = null)
	{
		...
		return $this->generatedFileNamePrefix . md5(implode("|", $files) . $this->getLastModified($files) .$this->module);
	}
	...
	protected function generate($files)
	{
            ...
            if (!file_exists($path)) {
                    ...
                    if( !file_exists(dirname($path))) mkdir($path, 0775, true);
